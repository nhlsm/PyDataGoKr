...
class Test0(unittest.TestCase):
    ...
    def test_rsp_1(self):
        rsp = svc.get_rsp(serviceKey=SVC_KEY, startCreateDt='20200825', endCreateDt='20200825')
        # logging.info('code: %s', rsp.status_code)
        # logging.info('hdr : %s', rsp.headers)
        # logging.info('cont: %s', rsp.content)
        self.assertEqual(rsp.status_code, 200)
    ...
    def test_rsp_126(self):
        rsp = svc.get_rsp(serviceKey=SVC_KEY, startCreateDt='20200401', endCreateDt='20200801')
        # logging.info('code: %s', rsp.status_code)
        # logging.info('hdr : %s', rsp.headers)
        # logging.info('cont: %s', rsp.content)
        self.assertEqual(rsp.status_code, 200)
